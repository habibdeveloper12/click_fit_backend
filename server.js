...
connection.connect((err) => {
  ...
  // Example of calling the 'addUser' stored procedure
  //   const email = "user@example.com";
  //   const password = "hashed-password"; // You should hash the password before inserting it
  //   const type = "regular";
...
app.post("/upload", upload.single("file"), (req, res) => {
  // Handle the uploaded images here, e.g., save them to a database
